...
world_elevation <- read_stars(here("labs","week1","data","worldelevation.tif"))

# country boundaries
world_vector <- read_sf(here("labs","week1","data","worldvector.gpkg"))

# major cities
world_cities <- read_sf(here("labs","week1","data","worldcities.gpkg"))
...
#repeat for the remaining objects (this was in the next section)
```
...
tm_shape(world_elevation) + 
  tm_raster() +
  tm_shape(world_vector) + #polygons of countries
  tm_borders()
...
```{r}
tm_shape(world_vector) +
  tm_borders(col = "red") #plot just the borders
```
...
```{r}
tm_shape(world_vector) +
  tm-polygons(fill = "life_exoectancy", 
              #fill.scale = tm_scale(values = "brewer.yl_gn"),
              # fill.scale = tm_scale(values = "brewer.Pastel1"),
...
tm_shape(world_cities) +
  tm_symbols(
    size = "pop2020",
    size.legend = tm_legend(orientation = "landscape") #orientation = portrait
  )
...
#            frame = TRUE) +
#   tm_layout(text.fonrfamily = "Montserrat", style = "beaver",
#             bg.color = "grey95")
...
tm_shape(world_vector) +
  ...
  tm_layout(text.fontfamily = "Montserrat",
            ...
            bg.color = "grey95",
            #color.saturation = ,
            panel.label.bg.color = 'tan')

#fill.scale(arguments: labels, breaks)
```
...
tmap_save(map1, here("labs","week1","outputs","tmap-example.png"))
```
